    ...
    <div className="registration-success">
      ...
      <div className="success-details">
        <div className="detail-card">
          ...
          <div>
            ...
            <span>Wednesday, July 29, 2026</span>
          </div>
        </div>
        <div className="detail-card">
      ...
      <div className="next-steps">
        ...
        <ul>
          ...
          <li><i className="fas fa-check"></i> Arrive at Rufus and Bee&apos;s by 10:00 AM on July 29 for check-in</li>
      ...
      <div className="social-share-section">
        ...
        <div className="share-buttons">
          <a
            href={`https://wa.me/?text=${encodeURIComponent(`🎮 Just registered for the Syncplay 2v2 EA Sports FC 26 Tournament on July 29! Team: ${registrationData?.teamName || 'We are in!'}. Join us 👉 https://syncplay.co/register`)}`}
            target="_blank"
          ...
          <a
            href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(`🎮 Just registered for the @syncplay_co 2v2 EA FC 26 Tournament on July 29! Team ${registrationData?.teamName || ''} is coming 🔥 #Syncplay #eFootball #EAFC26`)}&url=${encodeURIComponent('https://syncplay.co/register')}`}
            target="_blank"
            rel="noopener noreferrer"
        ...
        <section className="register-form-section">
          <div className="container">
            <div className="registration-full-message">
              ...
              <p>All {totalSlots} team slots have been filled for our Second Edition tournament on Wednesday, July 29, 2026.</p>
      ...
      <section className="register-hero">
        ...
        <div className="container">
          ...
          <div className="tournament-details-hero">
            <span><i className="fas fa-calendar"></i> Wednesday, July 29, 2026</span>
