...
const Home = () => {
  ...
  const newsArticles = [
    {
      id: 1,
      title: 'syncplay eSports Launches - Historic 2v2 Tournament November 30th',
    ...
    },
    {
      ...
      excerpt: loading 
        ? 'Registration is officially open for our first tournament! Limited slots available for ₦1.5M prize pool...'
        : `Registration is officially open! ${slotsRemaining} of ${totalSlots} team slots remaining. ₦1.5M prize pool. Entry fee is ₦100,000 per team...`,
